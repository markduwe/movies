	...
	$.getJSON($popularUrl+$api+$callback, function(data){
    	...
    	$.each(data.results, function(i,a) {
    		...
    		if(a.poster_path == null) {
    			res += '<img src="http://cf2.themoviedb.org/assets/e6497422f20fa/images/no-poster-w92.jpg">';
    		} else {
    			res += '<img src="http://cf2.imgobject.com/t/p/w1280'+a.backdrop_path+'">';
    		}
...
function search(str) {
	$.getJSON($searchUrl+$api+str+$page+'1'+$callback, function(data){
    	...
    	$.each(data.results, function(i,a) {
    		...
    		res += '<div class="span2">';
    		if(a.poster_path == null) {
    			res += '<img src="http://cf2.themoviedb.org/assets/e6497422f20fa/images/no-poster-w92.jpg" class="img-rounded">';
    		} else {
    			res += '<img src="http://cf2.imgobject.com/t/p/w92'+a.poster_path+'" class="img-rounded">';
    		}
    		res += '</div>';
    		res += '<div class="span5">';
...
function getMovie(str, year, title) {
	...
	$.getJSON($movieId+str+'?'+$api+$append+$callback, function(data){
    	...
    	movie += '<div class="span12">';
    	movie += '<div class="hero-unit" style="background: url(http://cf2.imgobject.com/t/p/w780'+data.backdrop_path+');">';
    	...
    	if(data.poster_path == null) {
    		movie += '<img src="http://cf2.themoviedb.org/assets/e6497422f20fa/images/no-poster-w185.jpg" class="img-rounded">';
    	} else {
	    	movie += '<img src="http://cf2.imgobject.com/t/p/w185'+data.poster_path+'" class="img-rounded">';
    	}
    	if(exists(data.belongs_to_collection)) {
	    	movie += '<h5>Part of</h5>';
	    	movie += '<img src="http://cf2.imgobject.com/t/p/w185'+data.belongs_to_collection.poster_path+'" class="img-rounded">';	 
    	...
    	$.each(data.casts.crew, function(i,a) {
    		if(a.profile_path == null) {
    			movie += '<div class="row castcrew" data-id="'+a.id+'"><div class="span1"><img src="http://cf2.themoviedb.org/assets/e6497422f20fa/images/no-poster-w45.jpg" class="img-rounded"></div><div class="span3"><strong>'+a.job+'</strong>:<br/>'+a.name + '</div></div>';
    		} else {
    			movie += '<div class="row castcrew" data-id="'+a.id+'"><div class="span1"><img src="http://cf2.imgobject.com/t/p/w45'+a.profile_path+'" class="img-rounded"></div><div class="span3"><strong>'+a.job+'</strong>:<br/>'+a.name + '</div></div>';
    		}
    	});
    	movie += '</div>';
    	movie += '<div class="span4">';
    	...
    	$.each(data.casts.cast, function(i,a) {
    		if(a.profile_path == null) {
	    		movie += '<div class="row castcrew" data-id="'+a.id+'"><div class="span1"><img src="http://cf2.themoviedb.org/assets/e6497422f20fa/images/no-poster-w45.jpg" class="img-rounded"></div><div class="span3"><strong>'+a.character+'</strong>:<br/>'+a.name + '</div></div>';
	    	} else {
	    		movie += '<div class="row castcrew" data-id="'+a.id+'"><div class="span1"><img src="http://cf2.imgobject.com/t/p/w45'+a.profile_path+'" class="img-rounded"></div><div class="span3"><strong>'+a.character+'</strong>:<br/>'+a.name + '</div></div>';
	    	}
    	});
    	movie += '</div>';
    	movie += '</div>';
    	...
    	$.each(data.similar_movies.results, function(i,a) {
    		movie += '<li class="span2"><div class="thumbnail"><img src="http://cf2.imgobject.com/t/p/w92'+a.poster_path+'" class="img-rounded"></div></li>';
    		if ( i == 5 ) return false;
    	});
    	movie += '</ul>'
    	movie += '</div>'
...
//    		movie += '<li class="span1 thumbnail"><img src="http://cf2.imgobject.com/t/p/w185'+a.file_path+'" class="img-rounded"></li>';
//    	});
//    	movie += '</div>'
//    	movie += '</div>';
    	movie += '<div class="row">';
...
function netflix(title, year) {
    ...
    var netflix = "http://odata.netflix.com/Catalog/Titles?$filter=Name%20eq%20%27"+nfTitle+"%27%20and%20ReleaseYear%20eq%20"+year+"&$format=json&$callback=net";
...
function person(str) {
	$.getJSON($personUrl+str+$apiPerson+$appendPerson+$callback, function(data){
    	...
    	if(data.profile_path == null) {
    		movie += '<p><img src="http://cf2.themoviedb.org/assets/e6497422f20fa/images/no-poster-w185.jpg" class="img-rounded"></p>';
    	} else {
	    	movie += '<p><img src="http://cf2.imgobject.com/t/p/w185'+data.profile_path+'" class="img-rounded"></p>';
    	}
    	...
    	if(data.credits.cast != null) {
	    	...
	    	$.each(data.credits.cast, function(i,a) {
	    		...
	    		movie += '<a class="pull-left"><img src="http://cf2.imgobject.com/t/p/w92'+a.poster_path+'" width="50"></a>';
...
function playInstant(NetflixApiId,Available,MovieId){
	...
	nflx.openPlayer('http://api.netflix.com/catalog/movie/' + playThis, 0, 0, devKey);
}
function addQueue(NetflixApiId,Available,MovieId){
	...
	getX = getX - 200;
	getY = getY;
	nflx.addToQueue('http://api.netflix.com/catalog/movie/' + addThis, getX, getY, devKey, 'devKey', 'addMe');
}
